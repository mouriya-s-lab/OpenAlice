...
| `plans/uta-refactor/design/research/fp-00..12-*.md` | 一手案例调查，核心设计每条 [证据] 的出处（00–05 FP 案例；06 对账/in-doubt；07 类型导出与外部编译；08 段池选库；09 原生 op 算法层/VectorTA、AoS/SoA、Rust SIMD；10 数组中间层与真实指标实测；11 闸门 9 原语层 demo；12 L2 订单簿 demo） |
