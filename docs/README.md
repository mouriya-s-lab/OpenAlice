...
| [[docs/uta-effect-runtime-architecture.md]] | [UTA Effect Runtime architecture](uta-effect-runtime-architecture.md) · [简体中文](uta-effect-runtime-architecture.zh-CN.md) · [初步源码映射](uta-effect-runtime-mapping/coverage.md) · [调整后的逐项调查](uta-effect-runtime-design/solutions/index.md) | Protected initial architecture, original source mapping, and complete adjusted capability-comparison inputs; investigation records are not an accepted successor design |
| [[docs/uta-capability-runtime-design.md]] | [UTA Capability Runtime 设计书](uta-capability-runtime-design.md) · [方法论与边界原文](uta-capability-runtime-design.md#design-methodology) · [研究实践](uta-capability-runtime-design/research-practice.md) · [本轮研究与裁决](uta-capability-runtime-design/current-research.md) · [渐进研究计划](../plans/uta-core-design-research.md) · [完整事件流与时序](uta-capability-runtime-design/event-flows.md) · [旧能力详细承接](uta-capability-runtime-design/legacy-accommodation.md) · [逐项绑定与原始问题](uta-capability-runtime-design/legacy-bindings.md) | Aligned methodology and adaptive research; candidate schema-bound computation construction, event consumption, provider/CLI interpretation, durable effect control and legacy accommodation, with scoped evidence; not an implemented runtime or accepted migration |
