...
| [[docs/uta-capability-runtime-design.md]] | [UTA Capability Runtime 设计书](uta-capability-runtime-design.md) · [方法论与边界原文](uta-capability-runtime-design.md#design-methodology) · [研究实践与本轮裁决](uta-capability-runtime-design/research-practice.md) · [渐进研究计划](../plans/uta-core-design-research.md) · [完整事件流与时序](uta-capability-runtime-design/event-flows.md) · [旧能力详细承接](uta-capability-runtime-design/legacy-accommodation.md) · [逐项绑定与原始问题](uta-capability-runtime-design/legacy-bindings.md) | Aligned design methodology, adaptive research evidence and gates; proposed schema-bound capability algebra, derived event types and bounded-context flows, provider/CLI interpretation, durable effect control, complete legacy accommodation, and executable falsifiers; not an implemented runtime or accepted migration |
