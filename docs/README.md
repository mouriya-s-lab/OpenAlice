...
| [[docs/uta-effect-runtime-design/solutions/index.md]] | [调整后的逐项调查](uta-effect-runtime-design/solutions/index.md) | Stripped source-evidence index (sourceEvidence, currentBehavior, problem, preservedBehavior, openQuestions); archived candidate models, closures and reviews are not design authority |
| [[docs/uta-capability-runtime-design.md]] | [UTA Capability Runtime 设计书](uta-capability-runtime-design.md) · [方法论与边界原文](uta-capability-runtime-design.md#design-methodology) · [研究实践](uta-capability-runtime-design/research-practice.md) · [本轮研究与裁决](uta-capability-runtime-design/current-research.md) · [渐进研究计划](../plans/uta-core-design-research.md) · [计算组合动态推导](uta-capability-runtime-design/event-flows.md) · [旧能力实质承接](uta-capability-runtime-design/legacy-accommodation.md) · [完整原始调查](uta-effect-runtime-design/solutions/index.md) | Candidate computation construction, state/result consumption, resource ownership and separate business derivations; original investigation identities remain preserved, superseded evidence is historical, and no implemented runtime or accepted migration is claimed |
